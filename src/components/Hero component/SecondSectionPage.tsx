...
const SecondSectionPage = () => {
  return (
    <div className="w-full py-4 flex flex-col-reverse sm:grid sm:grid-cols-2 items-center justify-start gap-2 bg-green-100/24">
      <div className="w-full px-8 py-4">
        <h1 className="font-semibold text-lg text-white italic px-8 bg-linear-to-r from-green-800 to-green-950 sm:mx-16">
          Temple Timing
        </h1>
        <div className="w-full max-w-111 h-80 overflow-y-auto mt-4 border sm:mx-16">
          <Timeline
            data={[
