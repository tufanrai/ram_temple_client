    ...
    <div className="w-full h-screen flex items-center justify-center">
      ...
      >
        <div className="w-full h-screen bg-black/58 sm:bg-linear-to-r flex justify-center sm:from-black/45 sm:to-white/0">
          <div className="max-w-[1280px] w-full flex flex-col-reverse items-center justify-start px-16 py-8 sm:flex-row sm:items-center sm:justify-center sm:px-8 sm:py-4">
            <MediaLinks />
            <div className="w-full flex flex-col rounded-sm border-[1px] border-black/24 bg-black/14 gap-3 shadow-lg py-4 px-16 sm:rounded-lg">
