...
const AboutFounder = () => {
  return (
    <div className="w-full h-screen flex items-center justify-center block">
      ...
      >
        <div className="w-full h-screen flex flex-col items-center justify-start overflow-hidden overflow-y-auto bg-black/64 sm:bg-linear-to-r sm:from-black/75 sm:to-white/0 sm:px-16">
